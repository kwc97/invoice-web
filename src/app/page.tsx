      ...
      <section className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-4 py-20 sm:py-32">
        ...
        <Container size="md">
          <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
            {/* 로고 - 라이트/다크 모드별 전환 */}
            <div className="mb-8">
              <div className="ring-border/50 inline-block rounded-xl bg-white px-5 py-3 shadow-sm ring-1 dark:bg-transparent dark:px-0 dark:py-0 dark:shadow-none dark:ring-0">
                <Image
                  src="/logo.png"
                  alt="케이프로텍"
                  width={240}
